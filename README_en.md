...
<p align="center">
  <a href="https://github.com/xiaoran67/core/releases/latest">
    <img src="https://img.shields.io/github/v/release/xiaoran67/core?label=Version" />
  </a>
  <a href="https://www.python.org/">
    <img src="https://img.shields.io/badge/python-3.13-47c219?label=Python" />
  </a>
  <a href="https://github.com/xiaoran67/core/releases/latest">
    <img src="https://img.shields.io/github/downloads/xiaoran67/core/total?label=GUI%20Downloads" />
  </a>
  <a href="https://hub.docker.com/repository/docker/xiaoran67/core">
    <img src="https://img.shields.io/docker/pulls/xiaoran67/core?label=Docker%20Pulls" />
  </a>
  <a href="https://github.com/xiaoran67/core/fork">
    <img src="https://img.shields.io/github/forks/xiaoran67/core?label=Forks" />
  </a>
</p>
...
🎉💻 [IPTV-Web](https://github.com/xiaoran67/core): IPTV live stream management platform, supports online playback and
other features, under development...

💖 [Channel Alias Collection Plan](https://github.com/xiaoran67/core/discussions/1082)
...
- [xiaoran67/iptv-database](https://github.com/xiaoran67/iptv-database)
...
```bash
https://raw.githubusercontent.com/xiaoran67/core/main/output/result.m3u
```

- IPv6

```bash
https://raw.githubusercontent.com/xiaoran67/core/main/output/ipv6/result.m3u
```

- IPv4

```bash
https://raw.githubusercontent.com/xiaoran67/core/main/output/ipv4/result.m3u
```

### VOD source

```bash
https://raw.githubusercontent.com/xiaoran67/core/main/source.json
```
...
1. Download the [IPTV-API Update Software](https://github.com/xiaoran67/core/releases), open the software, and click
...
Follow my GitHub account [xiaoran67](https://github.com/xiaoran67) to find more useful projects

### WeChat public account

WeChat public account search for Govin, or scan the code to receive updates and learn more tips:

![Wechat public account](./static/images/qrcode.png)

## Star History

[![Star History Chart](https://starchart.cc/xiaoran67/core.svg?variant=adaptive)](https://starchart.cc/xiaoran67/core)
...
[MIT](./LICENSE) License &copy; 2024-PRESENT [Govin](https://github.com/xiaoran67)
