...
🎉💻 [IPTV-Web](https://github.com/xiaoran67/iptv-web)：IPTV电视直播源管理平台，支持在线播放等功能，开发中...

💖 [频道别名收集计划](https://github.com/xiaoran67/update/discussions/12)
...
1. 下载[IPTV-API 更新软件](https://github.com/xiaoran67/core/releases)，打开软件，点击启动，即可进行更新
...
```bash
docker pull xiaoran67/core:latest
```

🚀 代理加速（推荐国内用户使用，可能会有缓存）：

```bash
docker pull docker.1ms.run/xiaoran67/core:latest
```

##### 2. 运行容器

```bash
docker run -d -p 5180:5180 xiaoran67/core
```
...
关注我的Github账号[xiaoran67](https://github.com/xiaoran67)，获取更多实用项目

### 微信公众号

微信公众号搜索 xiaoran67，或扫码，接收更新推送、学习更多使用技巧：

![微信公众号](./static/images/qrcode.png)
